...
import "./Card.css";
import avatar from "../images/kubi.jpg";
...
const PlayerCard = () => {
  ...
  return (
    ...
    >
      <img ref={imgRef} src={avatar} alt="avatar" className="avatar__img" />
      <h1 className="player__card__title" ref={titleRef}>
        Kubi Dogan
      </h1>
      <p ref={descRef}>
      ...
      <div className="button-box" ref={purchaseRef}>
        <button className="purchase">Select Player</button>
      </div>
    </div>
  );
};
